        ...
        <form action="#" class="mx-auto max-w-screen-xl px-4 ">
            <div class="mx-auto max-w-3xl px-4">
                ...
                <div class="space-y-4 border-b py-8 dark:border-gray-700">
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Información de la orden <span class="<%: orden.Estado.PillClass %> ml-4"><%: orden.Estado.Nombre %></span></h4>
                </div>
