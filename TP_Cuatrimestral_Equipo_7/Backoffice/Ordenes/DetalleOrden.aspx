                ...
                <div class="mt-6 sm:mt-8">
                    ...
                    <div class="mt-4 space-y-6">
                        ...
                        <div class="gap-4 sm:flex sm:items-center">
                            ...
                            <asp:Button ID="btnGenerateShoppingList" type="button" CssClass="mt-4 flex w-full items-center justify-center rounded-lg bg-primary-700  px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300  dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mt-0"  runat="server" OnClick="GenerateShoppingList">
